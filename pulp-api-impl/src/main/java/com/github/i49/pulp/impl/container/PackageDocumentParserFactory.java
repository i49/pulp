...
/**
 * The factory for creating instances of {@link PackageDocumentParser}.
 */
class PackageDocumentParserFactory {

	public PackageDocumentParser newParser(Document document) {
		
		Element rootElement = document.getDocumentElement();
		
		assertOn(rootElement)
		.hasName("package", PackageDocumentParser.NAMESPACE_URI)
